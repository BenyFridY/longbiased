"""
Backfill the 2026-05-22 (Fri) signal that was missed during paper-trade week
+ fill forward retornos on the previous rebal row (2026-05-15).

Strict no-look-ahead: feature row for the 2026-05-22 signal is filtered to
dataset[date <= 2026-05-22]. Cached models (trained 2026-04-27) were live on
...
TARGET_DATE = pd.Timestamp('2026-05-22')
DEC = 4
